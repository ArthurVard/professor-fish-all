 ...
 */
public class SortOutputFormat extends SequenceFileOutputFormat<LongWritable,Text> {
...
//    private final RecordWriter out;
    ...
    public MySortRecordWriter(FSDataOutputStream fileOut, JobContext job){
    	...
    	//out = new SequenceFileOutputFormat<LongWritable,Text>().getRecordWriter((TaskAttemptContext) job);
    	this.out = fileOut;
    }
