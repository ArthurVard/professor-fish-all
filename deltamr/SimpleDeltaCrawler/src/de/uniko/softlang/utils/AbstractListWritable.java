...
public abstract class AbstractListWritable implements Writable, Configurable {
  ...
  /** constructor. */
  protected AbstractListWritable() {
    ...
    //custom 
//    addToMap(PairWritable.class,
//        Byte.valueOf(Integer.valueOf(-112).byteValue()));
//    addToMap(ListWritable.class,
